...
import com.kedacom.ctsp.orm.dsl.Delete;
import com.kedacom.ctsp.web.dao.dynamic.DeleteByParamDao;
import com.kedacom.ctsp.web.entity.param.DeleteParamEntity;

/**
 * @author
 */
public interface DefaultDSLDeleteService<PK> extends DefaultDeleteService<PK> {
    DeleteByParamDao getDao();
    ...
    static Delete<DeleteParamEntity> createDelete(DeleteByParamDao deleteDao) {
