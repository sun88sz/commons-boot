...
public class Term implements Cloneable {
    ...
    public Term or(String term, TermType termType, Object value) {
    ...
    public Term and(String term, TermType termType, Object value) {
        Term queryTerm = new Term();
        queryTerm.setTermType(termType);
        queryTerm.setColumn(term);
        queryTerm.setValue(value);
    ...
    public void setColumn(String column) {
        ...
        if (column.contains("$")) {
            ...
            setTermType(TermType.parse(tmp[1]));
            column = tmp[0];
        }
        this.column = column;
    }
    ...
    public static Term build(String column, Object value) {
        return build(column, TermType.eq, value);
    }

    public static Term build(String column, TermType operator, Object value) {
        Term term = new Term();
        term.column = column;
        term.value = value;
